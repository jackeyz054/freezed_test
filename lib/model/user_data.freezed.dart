...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<int> id, String name, int age});
}
...
class _$UserImpl implements _User {
  const _$UserImpl(
      {required final List<int> id, required this.name, required this.age})
      : _id = id;
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_id), name, age);
